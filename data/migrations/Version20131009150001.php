...
CREATE TABLE phone_inbound_call (
    ...
    asterisk_unique_id varchar(16) COLLATE utf8_unicode_ci NOT NULL,
    asterisk_channel_id varchar(64) COLLATE utf8_unicode_ci NOT NULL,
    destination_number int(11) unsigned NOT NULL,
    phone_inbound_call_status_id tinyint(2) unsigned NOT NULL,
    dial_plan varchar(64) COLLATE utf8_unicode_ci NOT NULL,
    created_at datetime NOT NULL,
    updated_at datetime,
PRIMARY KEY (id),
KEY phone_inbound_call_status_id (phone_inbound_call_status_id),
CONSTRAINT fk_phone_inbound_call__phone_inbound_call_status_id FOREIGN KEY (phone_inbound_call_status_id) REFERENCES phone_inbound_call_status (id)
